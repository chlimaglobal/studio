...
const VisaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="1000" height="318" viewBox="0 0 1000 318" {...props}>
        ...
        <path fill="#F7B600" d="M999.9 203.8c0 53-33.1 82.3-88.8 82.3h-90.4V13.1h90.4c55.7 0 88.8 29.3 88.8 82.3v108.4zM904 104.4c0-20.8-9.4-31-29.3-31h-34.8v117.3h34.8c19.9 0 29.3-10.2 29.3-31V104.4z"></mainPath>
